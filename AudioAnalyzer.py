...
class AudioAnalyzer:
    ...
    def load(self, filename):
        ...
        self.tempo, _ = librosa.beat.beat_track(y=time_series, sr=sample_rate)
        self.tempo = float(self.tempo)
        self.spectral_centroid = librosa.feature.spectral_centroid(y=time_series, sr=sample_rate)[0]
        self.rms = librosa.feature.rms(y=time_series)[0]

        self.avg_centroid = np.mean(self.spectral_centroid)
